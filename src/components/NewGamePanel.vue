<template>
	<div id="panel">
		...
		<p>
			...
			leuke manier mee terug nemen naar het or-jaar 2020. Het was een roerig jaar
			door Corona waar we het allemaal zwaar mee hebben gehad. Tijdens dit spel kom
			je achter alle OR-onderwerpen die dit jaar hebben gespeeld.
		</p>
		<p class="mb-1">Wat is jouw naam:</p>
		<input id="name" class="animate__animated" v-model="name" type="text" /><br />
